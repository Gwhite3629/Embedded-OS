...
static inline void dummy_rotate(rb_node *old, rb_node *new) {}
...
static inline void
__rb_rotate_set_parents(rb_node *old, rb_node *new,
...
static inline void
__rb_insert(rb_node *node, rb_root *root,
...
static inline void
____rb_erase_color(rb_node *parent, rb_root *root,
	void (*augment_rotate)(rb_node *old, rb_node *new))
{
...
EXPORT(__rb_erase_color);

void __rb_insert_augmented(rb_node *node, rb_root *root,
	void (*augment_rotate)(rb_node *old, rb_node *new))
{
