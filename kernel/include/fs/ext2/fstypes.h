...
typedef struct superblock {
    ...
    uint16_t n_mount_nocheck;       // Number of times volume has been mounted since consistency check
    ...
    uint16_t host_block_group;      // Block group that this super is part of (for backups)
