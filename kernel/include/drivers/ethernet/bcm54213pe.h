#ifndef _BCM54213PE_H_
#define _BCM54213PE_H_

#define PHY_ID_BCM54213PE   0x600d84a2

#define CAST(X) ((X))

#define GENET_BASE_OFFSET       CAST(0x7d580000)
#define GENET_MDIO_OFFSET       CAST(GENET_BASE_OFFSET + 0xe14)
